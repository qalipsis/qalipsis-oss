...
/**
 * [StepSpecificationConverter] from [CounterMeterStepSpecificationImpl] to [CounterMeterStep].
 *
 * @author Francisca Eze
 */
@StepConverter
class CounterMeterStepSpecificationConverter(
...
) : StepSpecificationConverter<CounterMeterStepSpecificationImpl<*>> {

    override fun support(stepSpecification: StepSpecification<*, *, *>): Boolean {
        return stepSpecification is CounterMeterStepSpecificationImpl
    }

    override suspend fun <I, O> convert(creationContext: StepCreationContext<CounterMeterStepSpecificationImpl<*>>) {
        @Suppress("UNCHECKED_CAST")
        val spec = creationContext.stepSpecification as CounterMeterStepSpecificationImpl<I>
