...
/**
 * [StepSpecificationConverter] from [RateMeterStepSpecificationImpl] to [RateMeterStep].
 *
 * @author Francisca Eze
 */
@StepConverter
class RateMeterStepSpecificationConverter(
...
) : StepSpecificationConverter<RateMeterStepSpecificationImpl<*>> {

    override fun support(stepSpecification: StepSpecification<*, *, *>): Boolean {
        return stepSpecification is RateMeterStepSpecificationImpl
    }

    override suspend fun <I, O> convert(creationContext: StepCreationContext<RateMeterStepSpecificationImpl<*>>) {
        @Suppress("UNCHECKED_CAST")
        val spec = creationContext.stepSpecification as RateMeterStepSpecificationImpl<I>
