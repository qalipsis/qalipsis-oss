...
/**
 * [StepSpecificationConverter] from [ThroughputMeterStepSpecificationImpl] to [ThroughputMeterStep].
 *
 * @author Francisca Eze
 */
@StepConverter
class ThroughputMeterStepSpecificationConverter(
...
) : StepSpecificationConverter<ThroughputMeterStepSpecificationImpl<*>> {

    override fun support(stepSpecification: StepSpecification<*, *, *>): Boolean {
        return stepSpecification is ThroughputMeterStepSpecificationImpl
    }

    override suspend fun <I, O> convert(creationContext: StepCreationContext<ThroughputMeterStepSpecificationImpl<*>>) {
        @Suppress("UNCHECKED_CAST")
        val spec = creationContext.stepSpecification as ThroughputMeterStepSpecificationImpl<I>
