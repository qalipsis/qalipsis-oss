...
/**
 * Implementation of [Counter] that does not generate any [MeterSnapshot] in order to avoid duplicated
 * published values for global meters.
 */
@Suppress("UNCHECKED_CAST")
class UnpublishedCounter(
    private val meter: Counter,
) : Counter by meter,
    Meter.ReportingConfiguration<Counter> by (meter as Meter.ReportingConfiguration<Counter>) {
