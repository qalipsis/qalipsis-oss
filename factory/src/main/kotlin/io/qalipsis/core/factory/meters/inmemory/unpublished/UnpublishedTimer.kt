...
/**
 * Implementation of [Timer] that does not generate any [MeterSnapshot] in order to avoid duplicated
 * published values for global meters.
 */
@Suppress("UNCHECKED_CAST")
class UnpublishedTimer(
    private val meter: Timer,
) : Timer by meter,
    Meter.ReportingConfiguration<Timer> by (meter as Meter.ReportingConfiguration<Timer>) {
