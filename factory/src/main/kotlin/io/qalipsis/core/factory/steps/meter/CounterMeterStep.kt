...
/**
 * Step to create a [Counter] that allows for specification of failure conditions
 * and evaluation of success and failure of the steps using configured thresholds.
 *
 * @author Francisca Eze
 */
class CounterMeterStep<I>(
    id: StepName,
    ...
    private val checkers: List<Pair<Counter.() -> Double, ValueChecker<Double>>>,
    ...
    override suspend fun start(context: StepStartStopContext) {
        meter = campaignMeterRegistry.counter(
