...
/**
 * Implementation of [Rate] that does not generate any [MeterSnapshot] in order to avoid duplicated
 * published values for global meters.
 */
@Suppress("UNCHECKED_CAST")
class UnpublishedRate(
    private val meter: Rate,
) : Rate by meter,
    Meter.ReportingConfiguration<Rate> by (meter as Meter.ReportingConfiguration<Rate>) {
