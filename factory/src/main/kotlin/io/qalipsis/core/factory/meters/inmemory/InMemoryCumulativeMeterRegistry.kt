...
internal class InMemoryCumulativeMeterRegistry(
     ...
     */
    @KTestable
    private val globalMeterCache = ConcurrentHashMap<Meter.Id, Meter<*>>()
    ...
    override suspend fun init(campaign: Campaign) {
        ...
        if (campaign.scenarios.size == 1) {
            ...
            meterConverter = CompositeDecorator(meterReporter, globalMeterCache)
        }
    }

    override fun counter(meterId: Meter.Id): Counter {
        return globalMeterCache.getOrElse(meterId) {
