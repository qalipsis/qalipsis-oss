...
/**
 * Asserts the value is between the specified lower and upper bounds.
 *
...
class BetweenChecker<T : Comparable<T>>(
    ...
    /**
     * Performs the check to validate that a value is between the lower and upper bounds.
     */
    private fun isBetween(value: T, lowerBound: T, upperBound: T): Boolean {
