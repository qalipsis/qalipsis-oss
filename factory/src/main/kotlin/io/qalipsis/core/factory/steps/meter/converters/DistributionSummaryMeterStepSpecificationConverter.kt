...
/**
 * [StepSpecificationConverter] from [DistributionSummaryMeterStepSpecificationImpl] to [DistributionSummaryMeterStep].
 *
 * @author Francisca Eze
 */
@StepConverter
class DistributionSummaryMeterStepSpecificationConverter(
...
) : StepSpecificationConverter<DistributionSummaryMeterStepSpecificationImpl<*>> {

    override fun support(stepSpecification: StepSpecification<*, *, *>): Boolean {
        return stepSpecification is DistributionSummaryMeterStepSpecificationImpl
    }

    override suspend fun <I, O> convert(creationContext: StepCreationContext<DistributionSummaryMeterStepSpecificationImpl<*>>) {
        @Suppress("UNCHECKED_CAST")
        val spec = creationContext.stepSpecification as DistributionSummaryMeterStepSpecificationImpl<I>
        ...
        val step = DistributionSummaryMeterStep(
            id = spec.name,
