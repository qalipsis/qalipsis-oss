...
import io.qalipsis.core.factory.meters.inmemory.DurationProvider
...
@Warmup(iterations = 3)
internal class InMemoryCumulativeTimerWithPercentilesJmH {

    lateinit var meter: InMemoryCumulativeTimer

    @Setup(Level.Iteration)
    fun setUp() {
        meter = InMemoryCumulativeTimer(mockk<Meter.Id>(), mockk<MeterReporter>(), setOf(75.0, 99.9))
    }
