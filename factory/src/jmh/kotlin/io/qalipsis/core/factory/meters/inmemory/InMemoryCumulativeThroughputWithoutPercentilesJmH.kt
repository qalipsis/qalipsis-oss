...
@Warmup(iterations = 3)
internal class InMemoryCumulativeThroughputWithoutPercentilesJmH {

    lateinit var meter: InMemoryCumulativeThroughput

    @Setup(Level.Iteration)
    fun setUp() {
        meter = InMemoryCumulativeThroughput(mockk<Meter.Id>(), mockk<MeterReporter>(), ChronoUnit.SECONDS, emptySet())
    }
