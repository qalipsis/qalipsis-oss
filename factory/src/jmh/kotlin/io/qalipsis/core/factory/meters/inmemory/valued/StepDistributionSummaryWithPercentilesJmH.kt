...
@Warmup(iterations = 3)
internal class StepDistributionSummaryWithPercentilesJmH {

    lateinit var meter: StepDistributionSummary

    @Setup(Level.Iteration)
    fun setUp() {
        meter = StepDistributionSummary(mockk<Meter.Id>(), mockk<MeterReporter>(), setOf(75.0, 99.9))
    }
