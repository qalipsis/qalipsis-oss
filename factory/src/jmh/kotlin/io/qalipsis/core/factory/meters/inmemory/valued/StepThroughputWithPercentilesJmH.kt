...
@Warmup(iterations = 3)
internal class StepThroughputWithPercentilesJmH {

    lateinit var meter: StepThroughput

    @Setup(Level.Iteration)
    fun setUp() {
        meter = StepThroughput(mockk<Meter.Id>(), mockk<MeterReporter>(), ChronoUnit.SECONDS, setOf(75.0, 99.9))
    }
