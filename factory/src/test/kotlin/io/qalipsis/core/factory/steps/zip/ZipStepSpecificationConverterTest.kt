...
internal class ZipStepSpecificationConverterTest :
    AbstractStepSpecificationConverterTest<ZipStepSpecificationConverter>() {
    ...
    override fun `should support expected spec`() {
        // when+then
        assertTrue(converter.support(relaxedMockk<ZipStepSpecification<*, *>>()))
    }
    ...
    internal fun `should convert spec with name to step`() = runBlockingTest {
        // given
        val spec = ZipStepSpecification<Int, String>("other-step")
        spec.name = "my-step"
        ...
        // when
        converter.convert<String, Int>(creationContext as StepCreationContext<ZipStepSpecification<*, *>>)
