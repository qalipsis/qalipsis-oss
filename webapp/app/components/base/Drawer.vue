<template>
  ...
  >
    <div
      v-if="open"
      class="fixed inset-0 z-20 bg-gray-950 dark:bg-gray-800 bg-opacity-60 dark:bg-opacity-90 flex justify-center p-6"
  ...
  >
    <div
      v-if="open"
      class="fixed top-0 right-0 z-20 p-6 h-full bg-white dark:bg-gray-900 shadow-lg translate-none"
      ...
      <section class="flex flex-col h-full">
        <header class="flex justify-between mb-2">
          ...
          >
            <BaseIcon
              icon="qls-icon-close"
              class="text-2xl hover:text-primary-500"
            ></BaseIcon>
          </div>
        </header>
