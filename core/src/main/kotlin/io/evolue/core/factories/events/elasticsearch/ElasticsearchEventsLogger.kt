...
import io.evolue.core.factories.eventslogger.BufferedEventsLogger
...
/**
 * Implementation of [io.evolue.api.events.EventsLogger] for Elasticsearch.
...
) : BufferedEventsLogger(configuration.loggableLevel, configuration.lingerPeriod, configuration.batchSize) {
    ...
    override fun start() {
        runBlocking {
            try {
                ...
                if (response.contains(ERROR_RESPONSE_BODY_SIGNATURE)) {
        ...
        GlobalScope.launch(publicationContext) {
            ...
            try {
                ...
                if (responseBody.contains(ERROR_RESPONSE_BODY_SIGNATURE)) {
                    ...
                    // TODO Log all the detailed failures as warn.
