...
internal class DefaultCampaignManager(
    @PositiveOrZero private val minionsCountPerScenario: Int = 0,
    @Positive private val minionsCountFactor: Double = 1.0,
    @Positive private val speedFactor: Double = 1.0,
    @Positive private val startOffsetMs: Long = 1000,
    ...
    init {
        GlobalScope.launch {
            feedbackConsumer.subscribe().collect {
                processFeedBack(it)
            }
        }
    }
