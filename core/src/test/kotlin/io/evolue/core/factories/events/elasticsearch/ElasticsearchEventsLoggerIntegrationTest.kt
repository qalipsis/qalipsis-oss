package io.evolue.core.factories.events.elasticsearch

import com.fasterxml.jackson.databind.ObjectMapper
import com.fasterxml.jackson.databind.node.ObjectNode
import io.evolue.api.events.EventGeoPoint
import io.evolue.api.events.EventRange
import io.evolue.core.factories.eventslogger.elasticsearch.ElasticsearchEventsLoggerTest
...
internal class ElasticsearchEventsLoggerIntegrationTest {
    ...
    internal fun `should export data`(version: String, containerAndFormatter: EsContainerContext) {
    ...
    private fun requestEvents(url: String): ObjectNode {
        val response = runBlocking {
            ...
            httpClient.post<String>(url + "/evolue-events-*/_refresh")

            httpClient.get<String>(url + "/evolue-events-*/_search") {
                body = TextContent(
    ...
    class ElasticsearchContainer constructor(val version: String) :
    ...
    companion object {
        ...
        fun provideContainers() = Stream.of(
            Arguments.of(es6.version, EsContainerContext(es6.url, DateTimeFormatter.ISO_OFFSET_DATE_TIME)),
            Arguments.of(es7.version, EsContainerContext(es7.url, DateTimeFormatter.ISO_INSTANT))
        )
    }
