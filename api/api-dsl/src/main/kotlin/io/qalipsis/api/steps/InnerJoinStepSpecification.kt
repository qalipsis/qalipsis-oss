 ...
 * @author Eric Jessé
 */
fun <INPUT, OTHER_INPUT> StepSpecification<*, INPUT, *>.innerJoin(using: (CorrelationRecord<INPUT>) -> Any?,
 ...
 * @author Eric Jessé
 */
fun <INPUT, OTHER_INPUT> StepSpecification<*, INPUT, *>.innerJoin(using: (CorrelationRecord<INPUT>) -> Any?, on: String,
                                                                  having: (CorrelationRecord<OTHER_INPUT>) -> Any?): InnerJoinStepSpecification<INPUT, Pair<INPUT, OTHER_INPUT>> {
