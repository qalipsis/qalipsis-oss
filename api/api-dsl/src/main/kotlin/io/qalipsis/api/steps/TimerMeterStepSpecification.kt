...
//import io.qalipsis.api.meters.meterConditions.io.qalipsis.api.meters.meterConditions.TimerFailureConditionSpec
//import io.qalipsis.api.meters.meterConditions.FailureSpecification
//import io.qalipsis.api.steps.meterConditions.io.qalipsis.api.meters.meterConditions.TimerFailureConditionSpecImpl
...
//
//    fun shouldFailWhen(block: io.qalipsis.api.meters.meterConditions.TimerFailureConditionSpec.() -> INPUT): StepSpecification<*, INPUT, *> {
//        val timerFailureConditionSpecImpl = io.qalipsis.api.meters.meterConditions.TimerFailureConditionSpecImpl()
