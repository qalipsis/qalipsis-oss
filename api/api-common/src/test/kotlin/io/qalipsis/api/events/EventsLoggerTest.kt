...
internal class EventsLoggerTest {
    ...
    fun `should log as trace with var args tags`() {
        ...
        every {
            mockedLogger.log(EventLevel.TRACE, EVENT_NAME, EVENT_VALUE, EVENT_INSTANT,
    ...
    fun `should log as debug with var args tags`() {
        val tagsSupplierSlot = slot<(() -> Map<String, String>)>()
        every {
            mockedLogger.log(EventLevel.DEBUG, EVENT_NAME, EVENT_VALUE, EVENT_INSTANT,
                tagsSupplier = capture(tagsSupplierSlot))
        } returns Unit
    ...
    fun `should log as info with var args tags`() {
        val tagsSupplierSlot = slot<(() -> Map<String, String>)>()
        every {
            mockedLogger.log(EventLevel.INFO, EVENT_NAME, EVENT_VALUE, EVENT_INSTANT,
                tagsSupplier = capture(tagsSupplierSlot))
        } returns Unit
    ...
    fun `should log as warn with var args tags`() {
        val tagsSupplierSlot = slot<(() -> Map<String, String>)>()
        every {
            mockedLogger.log(EventLevel.WARN, EVENT_NAME, EVENT_VALUE, EVENT_INSTANT,
                tagsSupplier = capture(tagsSupplierSlot))
        } returns Unit
    ...
    fun `should log as error with var args tags`() {
        val tagsSupplierSlot = slot<(() -> Map<String, String>)>()
        every {
            mockedLogger.log(EventLevel.ERROR, EVENT_NAME, EVENT_VALUE, EVENT_INSTANT,
                tagsSupplier = capture(tagsSupplierSlot))
        } returns Unit
