...
class MinionsApiFeedbacksIntegrationTest {
    ...
    @Test
    fun `should encode and decode CompleteMinionFeedback as feedback`() {
        val feedback: Feedback =
            CompleteMinionFeedback("my-campaign", "my-scenario", "my-minion", COMPLETED, "The message").apply {
                nodeId = "the node"
                tenant = "the tenant"
            }
    ...
    @Test
    fun `should encode and decode MinionsShutdownFeedback as feedback`() {
        val feedback: Feedback =
            MinionsShutdownFeedback(
                "my-campaign",
                "my-scenario",
                listOf("my-minion-1", "my-minion-2"),
                COMPLETED,
                "The message"
            ).apply {
                nodeId = "the node"
