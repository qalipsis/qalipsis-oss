 ...
 */
fun readFileLines(input: InputStream, removeComments: Boolean = false, commentsToken: String = "#",
                  excludeEmptyLines: Boolean = true, trim: Boolean = true): List<String> {
 ...
 */
fun <T : Any> T.readResourceLines(resourceName: String, removeComments: Boolean = false,
                                  commentsToken: String = "#", excludeEmptyLines: Boolean = true,
                                  trim: Boolean = true) =
    readFileLines(this::class.java.classLoader.getResourceAsStream(resourceName)!!, removeComments, commentsToken,
