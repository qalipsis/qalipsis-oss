...
/**
 * Implementation of [CampaignConstraintsProvider] to constrain a running campaign.
 *
...
internal class DefaultCampaignConstraintsProvider(
    ...
    override suspend fun supply(tenant: String): DefaultCampaignConfiguration {
        return defaultCampaignConfiguration
    }
}