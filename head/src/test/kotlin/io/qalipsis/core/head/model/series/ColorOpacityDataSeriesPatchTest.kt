...
internal class ColorOpacityDataSeriesPatchTest {

    @Test
    internal fun `should update the data series color opacity when different`() {
        // given
        ...
        val patch = ColorOpacityDataSeriesPatch(15)
        ...
        assertThat(dataSeriesEntity).prop(DataSeriesEntity::colorOpacity).isEqualTo(15)
    }

    @Test
    internal fun `should not update the data series color opacity when equal`() {
        // given
        val dataSeriesEntity = DataSeriesEntity(
            reference = "my-data-series",
            tenantId = 123,
        ...
        assertThat(dataSeriesEntity).prop(DataSeriesEntity::colorOpacity).isEqualTo(10)
    }
}