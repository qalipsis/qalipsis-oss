...
class DirectiveKindTest {
    ...
    fun `should be able to serialize single use directive reference implementation`() {
        val directive: SingleUseDirectiveReferenceImpl<String> = SingleUseDirectiveReferenceImpl<String>("123", "unicast")
    ...
    fun `should be able to serialize single use directive`() {
        val directive: SingleUseDirective<String, SingleUseDirectiveReference<String>> = SingleUseDirectiveImpl("key", "123", "unicast")
        
        val jsonString = json.encodeToString(directive)
        
        val convertedDirective = json.decodeFromString<SingleUseDirective<String, SingleUseDirectiveReference<String>>>(jsonString)
        assertThat(convertedDirective).all {
    ...
    fun `should be able to serialize queue directive`() {
        val directive: QueueDirective<String, QueueDirectiveReference<String>> = QueueDirectiveImpl("key", listOf("123"), "unicast")
        
        val jsonString = json.encodeToString(directive)
        
        val convertedDirective = json.decodeFromString<QueueDirective<String, QueueDirectiveReference<String>>>(jsonString)
        assertThat(convertedDirective).all {
    ...
    fun `should be able to serialize list directive`() {
        val directive: ListDirective<String, ListDirectiveReference<String>> = ListDirectiveImpl("key", listOf("123"), "unicast")
        
        val jsonString = json.encodeToString(directive)
        
        val convertedDirective = json.decodeFromString<ListDirective<String, ListDirectiveReference<String>>>(jsonString)
        assertThat(convertedDirective).all {
    ...
    internal class ListDirectiveReferenceImpl<String>(override val key: DirectiveKey, override val channel: DispatcherChannel) : ListDirectiveReference<String>()

    @Serializable
    @SerialName("queueDirectiveReferenceImpl")
    internal class QueueDirectiveReferenceImpl<String>(override val key: DirectiveKey, override val channel: DispatcherChannel) : QueueDirectiveReference<String>()

    @Serializable
    @SerialName("singleUseDirectiveReferenceImpl")
    internal class SingleUseDirectiveReferenceImpl<String>(override val key: DirectiveKey, override val channel: DispatcherChannel) : SingleUseDirectiveReference<String>()

    @Serializable
    @SerialName("singleUseDirectiveImpl")
    internal class SingleUseDirectiveImpl(override val key: DirectiveKey, override val value: String, override val channel: DispatcherChannel) : SingleUseDirective<String, SingleUseDirectiveReference<String>>() {
    ...
    internal class QueueDirectiveImpl(override val key: DirectiveKey, override val values: List<String>, override val channel: DispatcherChannel) : QueueDirective<String, QueueDirectiveReference<String>>() {
    ...
    internal class ListDirectiveImpl(override val key: DirectiveKey, override val values: List<String>, override val channel: DispatcherChannel) : ListDirective<String, ListDirectiveReference<String>>() {
    ...
    internal class DescriptiveDirectiveImpl(override val key: DirectiveKey, override val channel: DispatcherChannel) : DescriptiveDirective()


    @Serializable
    @SerialName("directiveImpl")
    internal class DirectiveImpl(override val key: DirectiveKey, override val channel: DispatcherChannel) : Directive()

    private val module = SerializersModule {
        polymorphic(ListDirectiveReference::class) {
            subclass(ListDirectiveReferenceImpl::class, ListDirectiveReferenceImpl.serializer(PolymorphicSerializer(ListDirectiveReferenceImpl::class)) as KSerializer<ListDirectiveReferenceImpl<*>>)
        }
